 ...
 *	  Connection setup code for the V2 protocol
 *
 * Copyright (c) 2003, PostgreSQL Global Development Group
 * Copyright (c) 2004, Open Cloud Limited.
 *
 * IDENTIFICATION
 *	  $PostgreSQL: pgjdbc/org/postgresql/core/v2/ConnectionFactoryImpl.java,v 1.1 2004/06/29 06:43:25 jurka Exp $
 *
 *-------------------------------------------------------------------------
 */
...
public class ConnectionFactoryImpl extends ConnectionFactory {
	...
	private class SimpleResultHandler implements ResultHandler {
		...
		Vector getResults() { return tuples; }
