 ...
 *	  ProtocolConnection implementation for the V2 protocol.
 *
 * Copyright (c) 2004, Open Cloud Limited.
 *
 * IDENTIFICATION
 *	  $PostgreSQL: pgjdbc/org/postgresql/core/v2/ProtocolConnectionImpl.java,v 1.1 2004/06/29 06:43:25 jurka Exp $
 *
 *-------------------------------------------------------------------------
 */
