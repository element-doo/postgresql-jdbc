...
public abstract class AbstractJdbc3Connection extends org.postgresql.jdbc2.AbstractJdbc2Connection
{
	...
	public void setHoldability(int holdability) throws SQLException
	{
		...
		default:		
			throw new PSQLException("postgresql.con.holdable", PSQLState.NOT_IMPLEMENTED);
		}
	}
		...
		throws SQLException
	{
		if (autoGeneratedKeys != Statement.NO_GENERATED_KEYS)
			throw new PSQLException("postgresql.con.generatedkeys", PSQLState.NOT_IMPLEMENTED);
